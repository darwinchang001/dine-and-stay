      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Stay and Dine</h2>
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Phoenix Suns</a></li>
                <li><a href="#" class="py-2 d-block">+63984205757</a></li>
                <li><a href="#" class="py-2 d-block">phoenixsuns@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart"aria-hidden="true"></i> by <a href="https://www.youtube.com/watch?v=XEnZrtWsPr0" target="_blank">Phoenix Suns</a>
            </p>
          </div>
        </div>
      </div>
